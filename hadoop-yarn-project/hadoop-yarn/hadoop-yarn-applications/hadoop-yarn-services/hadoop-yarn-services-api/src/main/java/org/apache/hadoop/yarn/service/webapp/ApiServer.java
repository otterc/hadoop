...
public class ApiServer {
  ...
  public Response getComponentInstances(@Context HttpServletRequest request,
      @PathParam(SERVICE_NAME) String serviceName,
      @QueryParam(PARAM_COMP_NAMES) List<String> componentNames,
      @QueryParam(PARAM_VERSION) String version,
      @QueryParam(PARAM_CONTAINER_STATES) List<Enum<ContainerState>>
          containerStates) {
  ...
  private Container[] getContainers(UserGroupInformation ugi,
      ...
      List<Enum<ContainerState>> containerStates) throws IOException,
      InterruptedException {
